    ...
    <div class="search_events search-form-container">
        ...
        <div class="wpem">
            ...
            <div class="wpem-form-group">
                ...
                <input type="text" name="search_keywords" id="search_keywords" placeholder="<?php esc_attr_e('Search', 'wp-event-manager'); ?>" value="<?php echo esc_attr($keywords); ?>" />
            </div>
        ...
        <div class="wpem">
            ...
            <?php elseif ($show_event_types && !is_tax('event_listing_type') && get_terms('event_listing_type')) : ?>
                ...
                <div class="wpem-form-group">
                    ...
                    <?php else : ?>
                        <?php event_manager_dropdown_selection(array('value' => 'slug', 'taxonomy' => 'event_listing_type', 'hierarchical' => 1, 'show_option_all' => __('Add filter', 'wp-event-manager'), 'name' => 'search_event_types', 'orderby' => 'name', 'selected' => $selected_event_type, 'multiple' => false, 'hide_empty' => false)); ?>
                    <?php endif; ?>
                </div>
